    ...
    <div class="container" style="max-width: 600px;">
        ...
        <div class="card">
            ...
            <div class="card-body p-5">
                <form action="${pageContext.request.contextPath}/expense/edit" method="post" novalidate>
                    
                    <input type="hidden" name="csrfToken" value="${sessionScope.csrfToken}" />
                    
                    <input type="hidden" name="id" value="${not empty param.id ? param.id : expense.id}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" 
                               ...
                               maxlength="255" 
                               value="${not empty param.description ? param.description : expense.description}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="number" 
                               ...
                               step="0.01" 
                               value="${not empty param.amount ? param.amount : expense.amount}">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select id="categoryId" 
                            ...
                            <c:forEach var="cat" items="${categories}">
                                <c:set var="selectedId" value="${not empty param.categoryId ? param.categoryId : expense.categoryId}"/>
                                <option value="${cat.id}" 
                                    <c:if test="${cat.id.toString() == selectedId.toString()}">selected</c:if>>
                                    ${cat.name}
                                </option>
                            </c:forEach>
                        </select>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="date" 
                               ...
                               value="${not empty param.expenseDate ? param.expenseDate : expense.expenseDate}">
